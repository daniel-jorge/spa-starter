...
The specification should be saved in the [/specs/](/specs/) directory and named according to the following convention: `[a-z0-9-]+.spec.md`, where the name should be descriptive of the specification's content and starting with the highlevel purpose, which is one of [schema, tool, data, infrastructure, process, architecture, or design].
